...
export function Card({ header, imageUrl, textTitle="Last message", text, buttonLabel, onButtonClick, createdAt }) {
  return (
        ...
        <div className="ml-4 grow h-52">
          <div className="flex gap-8 max-h-36 mt-2">
            <div className="w-1/2">
              ...
              <p className="text-md text-gray-700 max-h-28 overflow-auto text-justify leading-2 pr-2">{text}</p>
            </div>
            <div className=" w-1/2">
              <h6 className="font-bold mb-2 text-center">Last message:</h6>
              <p className="text-md text-gray-700 max-h-28 overflow-auto text-justify leading-2 pr-2">{text}</p>
            </div>
          </div>
